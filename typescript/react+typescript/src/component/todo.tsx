            ...
            <div className="h-100 w-full flex items-center justify-center bg-teal-lightest font-sans mt-20">
                <div className="bg-[#012254] rounded-[10px] shadow p-6 m-4 w-full lg:w-3/4 lg:max-w-lg">
                    <div className="mb-4">
                        ...
                        <form action="" className='' onSubmit={(e) => handleadd(e)}>
                            <div className="flex mt-4">
                                ...
                                />
                                <button type="submit" className="text-white bg-[#145996] hover:bg-blue-800 font-semibold rounded-lg text-sm px-10 py-4 me-2 mb-2 inline-flex items-center ">Add <svg className='x' xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 448 512" fill='white'><path d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" /></svg></button>
